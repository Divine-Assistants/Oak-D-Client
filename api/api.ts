...
export async function getSingleUser(){
    const response = await axios.get('https://oakandd-api.onrender.com/users/single', {headers: {
...
export async function updateUserProfile(body: profileDataType){
    const response = await axios.post(`https://oakandd-api.onrender.com/users/update-profile`, body, {headers: {Authorization: `Bearer ${userToken}`}});
...
export async function verifyUser(code: verifyUserData){
    const response = await axios.post('https://oakandd-api.onrender.com/auth/user/verify', code);
...
export async function loginUser(body: LoginDataType){
    const response = await axios.post('https://oakandd-api.onrender.com/auth/user/login', body);
...
export async function forgotPassword(body: forgotPasswordType){
    const response = await axios.post('https://oakandd-api.onrender.com/auth/user/reset-password', body);
...
export async function verifyPasswordOTP(body: passwordOTP){
    const response = await axios.post('https://oakandd-api.onrender.com/auth/user/verify-password-reset', body);
...
export async function newPassword(body: newPasswordType){
    const response = await axios.post('https://oakandd-api.onrender.com/auth/user/add-new-password', body);
...
export async function deleteUser(id: string){
    const response = await axios.delete(`https://oakandd-api.onrender.com/users/${id}`, {headers: {
        Authorization: `Bearer ${userToken}`
    }});
...
export async function getUserPackage(packages: string[]){
    const response = await axios.post('https://oakandd-api.onrender.com/package/get-packages', {packages}, {headers: {
        Authorization: `Bearer ${userToken}`
    }});
