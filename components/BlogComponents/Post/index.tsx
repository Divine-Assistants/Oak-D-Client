  ...
  return (
    <section className='text-[#1E1E1E'>
            <div className='w-[90%] md:w-[80%] lg:w-[90%] mt-[52px] lg:mt-[96px] m-auto  '>
                    <h2 className='font-[700] text-[28px] text-center mb-[52px] lg:mb-[94px] lg:text-[64px] '>{}</h2>
            ...
            <div className='w-[90%] md:w-[80%] lg:w-[90%] m-auto text-[#1E1E1E] '>
                <p className='w-fit text-center text-[26px] font-[700] mb-[20px] md:text-[32px] '>Related Post</p>
