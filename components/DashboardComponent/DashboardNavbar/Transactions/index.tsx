    ...
    return (
        <div>
            <div className="flex justify-between mt-[20px] lg:mt-[50px] lg:mb-[25px] ">
                <p className="text-[20px] lg:text-[24px] font-[600] text-[#1E1E1E]">Transactions</p>
                <button className="text-[#0A089A] text-[13px] lg:text-[16px] font-[500]">View All</button>
            </div>

            <section className="w-[100%] lg:hidden flex flex-col rounded-[8px] px-[20px] ">
                {packageInfo.map(item=>{
                    return(
                        <div key={item._id} className="mb-[20px] bg-[#FEFEFE] rounded-[8px] p-[10px] ">
                            <div className="flex w-[100%] ">
                                <input type="checkbox" />
                                <div className="mr-auto ml-[10px] ">
                                    <p className="text-[16px] font-[600] text-[#1E1E1E]">Invoice #0456</p>
                                ...
                                <div className="flex items-center ">
                                   ...
                                   <Image 
                                        src={showDetails && isPackageClick===item._id ? `../img/arrow-up-icon.svg` : `../img/arrow-down-icon.svg`} 
                                        alt="Arrow Down" 
                                        width={15} 
                                        height={15}  
                            ...
                            {isPackageClick===item._id && showDetails && (
                                <div >
                                    <div className="flex justify-between my-[15px] px-[20px] ">
                                        <p className="text-[#B1B1B1] text[14px] font-[500] ">Recipient</p>
                                        <p className="text-[#1E1E1E] text[14px] font-[500] ">{`${item.receiver.firstName} ${item?.receiver.lastName}`}</p>
                                    </div>
                                    <div className="flex justify-between my-[15px] px-[20px] ">
                                        <p className="text-[#B1B1B1] text[14px] font-[500] ">Services</p>
                                        <p className="text-[#1E1E1E] text[14px] font-[500] ">{item.packageType}</p>
                                    </div>
                                    <div className="flex justify-between my-[15px] px-[20px] ">
                                        <p className="text-[#B1B1B1] text[14px] font-[500] ">Arrival</p>
                                        <p className="text-[#1E1E1E] text[14px] font-[500] ">{item.arrival}</p>
                                    </div>
                                    <div className="flex justify-between my-[15px] px-[20px] ">
                                        <p className="text-[#B1B1B1] text[14px] font-[500] ">Amount</p>
                                        <p className="text-[#1E1E1E] text[14px] font-[500] ">{item.price}</p>
                                    </div>


                                    <div className="flex justify-center border-[2px] border-[#1E1E1E] rounded-[15px] p-[15px] cursor-pointer ">
                                        <Image src="../img/download-icon.svg" alt="" width={25} height={25} className="mr-[10px] " />
            ...
            <section className="hidden lg:block" >
                <table className="w-full font-[400]">
                    ...
                    <tbody className="my-[20px] py-[20px] ">
                        {packageInfo.map(item=>{
                            return(
                                <tr className="bg-[#FFFFFF] border-b-4 border-[#F5F5F5] text-[16px] " key={item._id}>
                                    ...
                                    <td className="px-[10px] py-[15px]">{item.createdAt}</td>
                                    ...
                                    <td className="px-[10px] py-[15px]">
                                        <div className="flex justify-center items-center  cursor-pointer border-[1px] border-[#1E1E1E] rounded-[8px] px-[15px] py-[8px] ">
                                            <Image src="../img/download-icon.svg" alt="" width={15} height={15} className="mr-[2px] " />
