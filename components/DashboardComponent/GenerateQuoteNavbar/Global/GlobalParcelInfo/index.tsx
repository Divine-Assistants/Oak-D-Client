...
import { GlobalParcelInfoContext, GlobalSummaryContext, GlobalCrumbContext } from "@/context/GlobalShipping";
...
export function GlobalUserParcelInfo({setData}: ParcelInformationType){
    ...
    return(
        <section style={{display: globalParcelInfo && !globalSummary ? 'block' : 'none'}} className="p-[20px] ">
            <GlobalBreadcrumb />
            ...
            <div className='text-[24px] text-[#1E1E1E] font-[600] mb-[20px] lg:mb-0 lg:w-[500px] lg:text-[36px] '>
                <h1>Fill the form to get a Global <span className='text-[#A1A1A1] '>shipping summary</span> estimate</h1>
            </div>
            ...
            <form className='w-[100%] lg:w-[70%] '>
                ...
                <div className='flex flex-col lg:flex-row lg:gap-x-[20px] items-center '>
                    <div className='mb-[15px] flex flex-col text-[#1E1E1E] text-[16px] w-[100%] '>
                        <label htmlFor="departure" className='mb-[8px] font-[600] '>Departure</label>
                        <select name="departure" value={parcelData.departure} onChange={handleParcelDataChange} id="departure" className='p-[15px] border-[2px] border-[#CBCBCB] rounded-[8px] bg-[#F5F5F5] focus:outline-[#0A089A] w-[100%] ' >
                    ...
                    <div className='mb-[15px] flex flex-col text-[#1E1E1E] text-[16px] w-[100%] '>
                    <label htmlFor="arrival" className='mb-[8px] font-[600] '>Arrival</label>
                        <select name="arrival" value={parcelData.arrival} onChange={handleParcelDataChange} id="arrival" className='p-[15px] border-[2px] border-[#CBCBCB] rounded-[8px] bg-[#F5F5F5] focus:outline-[#0A089A] w-[100%] ' >
