...
import { ReceiverInformationContext, ParcelInformationContext } from '@/context/UserDashboardGenerateQuote';
import { GlobalReceiverInfoContext, GlobalParcelInfoContext, GlobalCrumbContext } from '@/context/GlobalShipping';
...
export function GlobalUserReceiver({setData}: ReceiverInformationType){
    ...
    return( 
        <section style={{display: globalReceiverInfo && !globalParcelInfo ? 'block' : 'none'}} className="p-[20px] ">
            ...
            <div className='text-[24px] text-[#1E1E1E] font-[600] mb-[20px] lg:mb-0 lg:w-[500px] lg:text-[36px] '>
                <h1>Please enter the <span className='text-[#A1A1A1] '>Global receiver's information</span> to proceed</h1>
            </div>
