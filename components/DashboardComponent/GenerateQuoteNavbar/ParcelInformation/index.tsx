...
import { ParcelInformationContext, ShippingSummaryContext, ReceiverInformationContext, DomesticBreadcrumbContext } from "@/context/UserDashboardGenerateQuote";
...
export function ParcelInformation({setData}: ParcelInformationType){
    ...
    return(
        <section style={{display: showParcelInfo ? 'block' : 'none'}} className="p-[20px] ">
            <DomesticBreadcrumb />
