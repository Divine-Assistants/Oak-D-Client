...
import { ShippingSummaryContext, QuoteModalContext, ShowPaymentPageContext, IsDomesticContex, DomesticBreadcrumbContext } from "@/context/UserDashboardGenerateQuote";
...
export function ShippingSummary({data}: ShippingSummaryType){
    ...
    return(
        <section style={{display: showShippingSummary ? 'block' : 'none'}} className="p-[20px] ">
            <DomesticBreadcrumb />
