...
import { WarehouseSenderInfoContext, WarehouseParcelInfoContext, WarehouseBreadcrumbContext } from '@/context/Warehouse';
...
export function WarehouseSenderInfo({setData}: SenderInformationProps){
    ...
    return( 
        <section style={{display: showWarehouseSenderInfo ? 'block' : 'none'}} className=" p-[20px]">
            <WarehouseBreadcrumb />
            ...
            <div className='text-[24px] text-[#1E1E1E] font-[600] mb-[20px] lg:mb-0 lg:w-[500px] lg:text-[36px] '>
                <h1>Please enter the <span className='text-[#A1A1A1] '> your information</span> to proceed</h1>
            </div>
