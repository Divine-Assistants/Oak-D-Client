...
import { senderInfoContext, receiverInfoContext, packageInfoContext } from "@/context/PackageInfo";
...
export function GenerateQuoteNavbar(){
    ...
    return(
        ...
        <div style={{display: activeNav === 2 ? 'block' : 'none'}} className="lg:col-span-10 lg:row-span-5 bg-[#F5F5F5]">
            <TypeOfService />
