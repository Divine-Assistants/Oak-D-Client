...
import { initialUserDataType } from "..";
...
export function SettingTopNav(props: SettingTopNavType){
    ...
    return (
        <section className=" ">
            <h1 className="hidden lg:block text-[24px] text-[#1E1E1E] font-[600] mb-[30px] ">My Profile</h1>
            ...
            <div className="flex items-center border-[2px] border-[#F3F3F3] rounded-[10px] p-[20px] ">
                ...
                <div>
                    ...
                    <p className="text-[16px] text-[#9C9C9C] font-[600] lg:text-[20px] ">{email}</p>
                </div>
            </div>
        </section>
    )
