    ...
    <div className="flex flex-col p-[20px] lg:flex-row lg:items-center">
      <div className="relative mb-[20px] lg:mb-0 flex items-center w-[450px]">
        <Image
          ...
          width={20}
          height={20}
          className="absolute top-[50%] left-[20px] transform translate-y-[-50%] "
        />

        <input
          type="text"
          placeholder="Search by invoice no/services/billing date"
          className="w-[100%] bg-[#FEFEFE] p-[20px] pl-[45px] outline-none rounded-[8px] "
        />
      </div>
