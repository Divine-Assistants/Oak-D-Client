...
export function VidModal() {
  ...
  return (
    <div className='bg-[#1E1E1E]/[.4] fixed top-0 left-0 h-[100vh] w-[100%] ' style={{display: showVideo === true? 'block' : 'none'}} onClick={handleClick}>
            <div className='bg-black m-auto mt-[10%] lg:w-[60%] h-[60%]   ' onClick={handleVideoClick}>
