...
export function DomesticParcel({setData}: DomesticParcelType) {
  ...
  selectedArrivalProvince, setSelectedArrivalProvince, setShowVideo
...
const handleProvinceArrivalChange = (event: React.ChangeEvent<HTMLSelectElement>) => {
  ...
  const [parcelData, setParcelData] = useState<clientParcelInfo>(initialDomesticParcelInfo);

  const handleParcelDataChange = (event: React.ChangeEvent<HTMLInputElement | HTMLSelectElement>)=> {
  ...
  return (
    ...
    <div className=' w-[90%] m-auto md:flex md:justify-between '>
            <div className='mb-[60px] md:w-[40%] mt-[49px] '>
                 <h1 className='text-[16px] font-[600] text-[#AC0108] mb-[15px] block md:hidden '>Parcel Information</h1>
                 <p className=' text-[40px] font-[600] '>Fill the form to get a <span className='text-[#A1A1A1]'>Shipping summary</span> estimate</p>
            </div>
            <div className='flex flex-col md:w-[50%] '>
    <form className=' '>
        <div  className='flex flex-col gap-[10px] mb-[25px]'>
            <label htmlFor="packageName" className='font-[600] '>Name Of Cargo</label>
            <input 
              type="text" 
              name="packageName"
        ...
        <div  className='flex flex-col gap-[10px] mb-[25px]'>
            <label htmlFor="packageWeight" className='font-[600] '>Weight</label>
        ...
        <p className='text-[15px] text-[#AC0108] font-[600] cursor-pointer mb-[25px] ' onClick={()=>setShowVideo(true)}>Need help measuring the dimension?</p>
        ...
        <div  className='flex flex-col gap-[10px] mb-[25px]'>
            <label htmlFor="packageDescription" className='font-[600] '>Parcel Description</label>
            <input 
              type='text' 
    ...
    <div className=''>
      <button type='button' className='flex items-center gap-[10px] text-[#FEFEFE] text-[16px] font-[500] px-[55px] py-[21px] bg-[#0A089A] rounded-[15px] m-auto mb-[120px] md:px-[140px] md:py-[27px] md:mr-[5%] hover:bg-[#1E1E1E] '
