  ...
  return (
    ...
    <div className=' w-[90%] m-auto md:flex md:justify-between mb-[100px] '>
            ...
            <div className='flex-col gap-[47px] text-[16px] font-[600] text-[#1E1E1E] md:w-[55%] border-2 border-[#E7E7E7] px-[25px] rounded-[15px] pt-[30px] '>
                ...
                <button className='flex items-center gap-[10px] text-[#FEFEFE] text-[16px] font-[500] px-[55px] py-[21px] bg-[#0A089A] rounded-[15px] m-auto mb-[60px] md:px-[75px] md:py-[27px] md:ml-[25%] hover:bg-[#1E1E1E] '
                                   onClick={()=>{
                                    setTrail(4);
                                    scrollToTop()
                                   }}
