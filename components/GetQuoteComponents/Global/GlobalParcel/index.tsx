...
export function GlobalParcel({setData}: GlobalParcelType) {
    ...
    const [parcelData, setParcelData] = useState<clientParcelInfo>(initialGlobalParcelInfo);
    ...
    return (
        ...
        <div className=' w-[90%] m-auto md:flex md:justify-between '>
                ...
                <div className='md:w-[50%] ' style={{display: glotrail === 2? 'block' : 'none'}}>
    <form>
    ...
    <div  className='flex flex-col gap-[10px] mb-[25px]'>
        ...
        <input type='text' id="" className='rounded-[15px] border border-[#A1A1A1] h-[165px] outline-[#0A089A] placeholder-[]  pl-[24px] pt-[0px] ' placeholder='' />
    </div>
</form>
    <div className=''>
    <button className='flex items-center gap-[10px] text-[#FEFEFE] text-[16px] font-[500] px-[55px] py-[21px] bg-[#0A089A] rounded-[15px] m-auto mb-[120px] md:px-[140px] md:py-[27px] md:mr-[5%] hover:bg-[#1E1E1E] '
