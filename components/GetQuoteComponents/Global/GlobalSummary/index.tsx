  ...
  return (
    ...
    <div className=' w-[90%] m-auto md:flex md:justify-between mb-[100px] '>
            <div className='mb-[60px] md:w-[40%] mt-[49px] '>
                 <h1 className='text-[16px] font-[600] text-[#AC0108] mb-[15px] block md:hidden '>Shipping Summary</h1>
            ...
            <div className='flex-col gap-[47px] text-[16px] font-[600] text-[#1E1E1E] md:w-[55%] border-2 border-[#E7E7E7] px-[25px] rounded-[15px] pt-[30px] '>
                <h2 className='text-[18px] md:text-[24px] font-[600] text-center '>Shipping Summary</h2>
                ...
                <button className='flex items-center gap-[10px] text-[#FEFEFE] text-[16px] font-[500] px-[55px] py-[21px] bg-[#0A089A] rounded-[15px] m-auto mb-[60px] md:px-[155px] md:py-[27px] hover:bg-[#1E1E1E] '
         ...
         {/* Modal page */}
         <div className='bg-[#1E1E1E]/[.4] absolute top-0 w-[100vw] h-[190%] md:h-[160%] ' style={{display: trail === 3.5? 'block' : 'none'}} >
                <div className='fixed bg-[#FEFEFE] w-[80%] md:w-[60%] m-auto rounded-[15px] top-[10%] left-[10%] md:left-[20%] py-[40px] md:py-[61px] '>
                      <div className='w-[80%] m-auto text-center '>
                            ...
                            <div className='flex items-center gap-[10px] md:gap-[24px] md:text-[26px] text-[16px] font-[500] text-[#FEFEFE] justify-center '>
                                ...
                                <button onClick={()=>{setGlotrail(4)}} className='bg-[#0A089A] py-[16px] md:py-[20px] px-[13px] md:px-[22px] rounded-[10px] '>Contact Us</button>
                            </div>
                      </div>
                </div>
        </div>
