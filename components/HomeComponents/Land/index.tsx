    ...
    <div className="100vh 100vw relative lg:mb-[160px]">
      ...
      <div className="absolute top-[0px] text-[#FEFEFE] ">
        <div className="w-[95%] text-center m-auto mt-[92px] md:mt-[19px] font-[500] mb-[47px] md:mb-[0px] lg:mb-[50px] lg:w-[80%] lg:mt-[79px] lg:m-auto ">
          <h2 className="font-[700] text-[45px] mb-[20px] md:mb-[5px] md:w-[50%] lg:w-[60%] lg:text-[70px] md:text-left  ">
            Fast and Reliable Cargo & Freight Shipping
          </h2>
          <p className="mb-[47px] md:mb-[5px] lg:mb-[50px] text-[16px] md:w-[50%] lg:text-[20px] lg:w-[50%] md:text-left ">
