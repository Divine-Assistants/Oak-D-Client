...
type Testimonial = {
  ...
  return (
          <>
          {/* small screens */}
    <Carousel  showThumbs={false} autoPlay interval={5000} transitionTime={5000} infiniteLoop className='block lg:hidden' >
             {testimonials.map((testimonial) => (
      
            <div className='rounded-[10px] bg-[#F5F5F5] py-[42px] w-[80%] m-auto ' key={testimonial.id}>
                 <div className='w-[80%] m-auto flex flex-col gap-[29px] '>
                   <div className='w-[79px] h-[58px] '><img src="/img/exclamation.svg" alt="Testimonial" className='w-[100%] h-[100%] ' /></div>
