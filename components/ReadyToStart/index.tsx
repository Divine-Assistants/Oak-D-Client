...
export const Ready = ()=> {
    return (
        <>
            <section style={styles.getStartedSection} className="py-[70px] px-[10px] text-[#F5F5F5] font-poppins flex flex-col justify-center">
                ...
                <button className="w-[160px] p-[20px] bg-[#0A089A] mx-auto border-0 text-[16px] rounded-[10px] cursor-pointer md:text-[18px]" ><Link href={'/get-started'}>Get Started</Link></button>
            </section>
        </>
    )
}
