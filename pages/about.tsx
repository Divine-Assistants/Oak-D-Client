    ...
    <div className="about-container font-poppins">
        ...
        <div className=" md:flex ">
          <div className="bg-blue text-white py-10 px-[20px] md:px-[50px] md:w-1/2 flex flex-col justify-center">
            ...
            <p className="text-[16px] md:text-[18px]">
              ...
              communities we serve. We aim to build long-term relationships with
              our customers and partners, while continuously improving our
              operations to meet evolving needs of the global market
            </p>
          </div>
          <div className="w-full md:w-1/2">
            <Image
      ...
      <section className="bg-white py-20 px-4 text-black font-poppins flex flex-col md:flex-row md:justify-between md:px-10">
        ...
        <p className="text-xl font-bold md:max-w-md">
          ...
          <span className="text-red">extra mile</span> and delivered to my home{" "}
          <span className="text-gray">saving me the trouble</span> of picking
          up. <span className="text-red">I recommend them</span> for your
          shipping needs <span className="text-gray">to and from</span> Nigeria”
        </p>
      </section>
      ...
      >
        ...
        <div className="md:max-w-xl">
          ...
          <p className="text-base mb-8">
            ...
            the utmost care and attention. We use state-of-the-art equipment and
            advanced technology to ensure that your goods are tracked and
          ...
          <p className="text-base">
            ...
            the way. Our customer service team is always available to answer any
            questions or concerns you may have, and we are committed to going
      ...
      <section className="bg-white flex flex-col py-20 px-4 md:flex-row md:justify-between md:px-10">
        ...
        <div className="md:max-w-xl">
          <p className="text-base font-bold">
            ...
            to go above and beyond, every day, for every shipment. With OAK & D,
