        ...
        <div>
            <div className="font-poppins px-[10px] md:px-[0px]">
                <div className="flex justify-between">
                    ...
                    <form onSubmit={handleLoginSubmit} className="mx-auto w-[100%] md:w-[70%] lg:px-[50px] lg:mx-0 lg:py-[100px] lg:w-[100%] xl:px-[150px]">
                        <div className="flex flex-col justify-center text-[#1E1E1E] mb-[30px] ">
                            <h1 className="text-[32px] font-[600] text-center mb-[5px]">Welcome Back</h1>
                        </div>
                        ...
                        <div className="flex flex-col mb-[10px]">
                            <label htmlFor="password" className="mb-[10px] text-[18px] font-[500]">Password</label>
                            <input 
                                id="password" 
                                type="password"
                                name="password"
                        ...
                        <div className="flex flex-col text-[16px] lg:text-[18px] font-[500] lg:flex-col-reverse">
                            <Link href="/forgot-password" className="text-[#0A089A] mb-[30px] lg:mb-[0px]">Forgot Password?</Link>
                            <div className="flex justify-center lg:mb-[10px] lg:justify-between">
                                <p className="mr-[10px]">Don't have an account?</p>
                                <Link href="/get-started" className="text-[#0A089A]">Sign Up</Link>
                            </div>
                        </div>
                        
                        <button type="submit" className="p-[20px] w-[100%] text-[#FAFAFA] mt-[10px] lg:mt-[50px] mb-[15px] text-center bg-[#0A089A] rounded-[8px] font-[500]">Log In</button>
