...
const Global = ()=> {
    ...
    return (
        <div>
            ...
            <div className="w-64 p-4 mx-auto font-poppins md:ml-20 md:w-96" style={styles.whiteBox}>
                    <h1 className='text-red text-xl font-bold mb-4 uppercase'>Pricing</h1>
                    <h2 className='text-black text-2xl font-bold mb-4'>How we price your items by weight and size
                    </h2>
                    <p className='text-black text-lg'>Below is how we charge handling for shipment from Lagos to Canada. Freight is charged at N2,600/kg</p>
                </div>
            </section>
            ...
            <section className='py-20 px-4 font-poppins '>
                <p className='text-black font-bold text-xl text-center md:max-w-2xl md:mx-auto'><span className='text-red'>Note:</span> Shipment within Canada is shipped based on weight and dimension of the package and shipment from Canada to Lagos is charged at $12/kg</p>
            </section>
            ...
            <section className='py-20 md:flex justify-between md:px-20'>
                <div className='w-full md:max-w-lg md:mr-20  '>
                    <img src='../img/pricing-page-delivery-person.svg' alt='' className='md:h-full' />
                </div>
