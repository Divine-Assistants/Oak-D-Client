import { Checkout, DomesticCrumb, DomesticParcel, DomesticQuoteLand, DomesticReciever, DomesticSender, DomesticSummary, Invoice, QuoteBtn, QuoteCrumb, QuoteLayout, ShipSummary } from '@/components'
  ...
  return (
    <QuoteLayout>
        ...
        <DomesticContextProvider>
            ...
            <Checkout data={data} registerPackage={registerPackage} onchange={function (value: string): void {
            throw new Error('Function not implemented.')
          } } />
            <Invoice invoiceNumber={''} date={''} items={[]} />
        </DomesticContextProvider>
        </main>
    </QuoteLayout>
  )
