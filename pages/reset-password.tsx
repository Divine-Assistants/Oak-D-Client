        ...
        <div >
            <div className="font-poppins px-[10px] md:px-[0px]">
                ...
                <div className="flex justify-between">
                    ...
                    <form onSubmit={handlePasswordSubmit} className="mx-auto sm:w-[70%] lg:px-[50px] lg:mx-0 lg:py-[150px] lg:w-[100%] xl:px-[150px]">
                        <div className="flex flex-col justify-center text-[#1E1E1E] mb-[30px] ">
                            <h1 className="text-[32px] font-[600] text-center mb-[5px]">Reset Password</h1>
                            <p className="text-[18px] text-center">Please reset your password</p>
                        </div>
                        <div className="flex flex-col mb-[30px]">
                            <label htmlFor="newPassword" className="mb-[10px] text-[18px] font-[500]">New Password</label>
                            <input 
                                id="newPassword" 
                                type="password"
                                name="newPassword"
                        ...
                        <div className="flex flex-col mb-[30px]">
                            <label htmlFor="confirmPassword" className="mb-[10px] text-[18px] font-[500]">Confirm Password</label>
                            <input 
                                id="confirmPassword" 
                                type="password"
                        ...
                        <button className="p-[20px] w-[100%] text-[#FAFAFA] mt-[15px] text-center bg-[#0A089A] rounded-[8px]">Submit</button>
                    </form>
                </div>
            </div>
        </div>
